...
function Comment(props) {
    ...
    const [isReplingComment, setIsReplingComment] = useState(false);
    const handleReplyButton = () => setIsReplingComment(isReplingComment ? false : true)
    const handleEditButton = () => setIsEditingComment(isEditingComment ? false : true)
